...
int main(int argc, char const *argv[])
{
	...
	const std::vector<std::vector<float>> ganhosPorAposta = {
		{0,3},
		{0,1,9},
		{0,1,2,16},
		{0,0.5,2,6,12},
	...
	std::cout << "Você está indo para um total de " << rodadas << " rodadas, cada uma valendo R$ "
			  << actualBet.getWage()/rodadas<< " reais" << std::endl;
	std::cout << std::endl;
	...
	for (unsigned int i = 0; i < numeros_apostados.size(); ++i)
		std::cout << numeros_apostados[i] << " ";
	std::cout << "]"<< std::endl;
	...
	{
		std::cout << "----------------------------------------------------------------------------------------------------------------------------------------------------------------" << std::endl;
		std::cout << "Esta é a rodada #" << i << " de " << rodadas << ", valendo R$ "
				  << apostaPorRodada << ". Boa sorte!" << std::endl;
		...
		else
		{
 		...
 		for (unsigned int i = 0; i < numerosAcertados.size(); ++i)
 			std::cout << numerosAcertados[i] << " ";
		std::cout << "], você acertou um total de " << numerosAcertados.size() << " de um total de "
				  << numeros_apostados.size() << ", a taxa de pagamento é de "
				  << ganhosPorAposta[numeros_apostados.size()-1][numerosAcertados.size()] 
				  << ", assim você saiu com: R$ "<< saldoPorRodada << std::endl;
